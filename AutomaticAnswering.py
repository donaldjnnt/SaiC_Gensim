...
if __name__=='__main__':
    ...
    if len(text_input) > 0:
        ...
        #v2w_model = gensim.models.KeyedVectors.load_word2vec_format(r'C:\Users\Darcey\Downloads\SaiC_Gensim_GITHUB\GoogleNews-vectors-negative300.bin.gz', binary=True, limit = 10000)
        ...
        #except:
        v2w_model = api.load('semeval-2016-2017-task3-subtaskA-unannotated')
